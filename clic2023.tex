...
\begin{table}
  \centering
  \caption{Examples of racist \paolo{and misogynous} posts from \dsITclassification. \paolo{G~$=$~Gold, P~$=$~Predicted.}}
  \label{tab:examples}
  \begin{tabular}{p{5cm}@{\hspace{1.5mm}}|c@{\hspace{1.5mm}}|c|c}
  \hline
  \bf Post & \bf Class & \bf G & \bf P\\
  \hline
  Compagno le n3gr3 sono oggettivamente brutte, le asiatiche lo sono in media - ma quelle belle lo sono davvero e staccano di misura le cosiddette belle nostrane. & Both & 3 & 3 \\
  \hline
  No perchè sessualmente mi fanno schifo le negre e i trans (più questi ultimi eh). & Both & 3 & 3 \\
  \hline
  Ora capisco perché non scopava, curry percepito anche se non è curry, currycel in pratica. & Racist & 2 & 2 \\
  \hline
  Che dire allora dei terroni quasi tutti arabi quindi negri e di quei rari bianchi europei che provengono da altre nazioni europee? La mafia cioè i terroni stanno importando queste merde in massa per farci terronizzare e negrizzare come loro. & Racist & 2 & 2 \\
  \hline
  le 8+ sono davvero rare. tuttavia, dal 5 in su si atteggiano tutte come fossero modelle... & Misog. & 1 & 0 \\
  \hline
  Probabilmente la vedrai tra qualche settimana ad ipergamare con qualche architetto & Misog. & 1 & 1 \\
  \hline
  \end{tabular}
\end{table}
