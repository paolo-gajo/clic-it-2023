...
\todoP{there was only training data in the datasets, so I assume teams had to split the dataset into train and dev themselves for the competitions. i use the train set, split it 70/30 and use it for train/dev. i did not use the test sets because i'm only testing on the italian incel forum dataset.}
