...
\begin{table}[t]
  \centering
  \caption{Statistics of the \enforum\, and \itforum\, (\textit{FdB}) unsupervised corpora. Mean length computed at token level \paolo{(w/ BertTokenizer\footnote{\url{https://huggingface.co/docs/transformers/model_doc/bert\#transformers.BertTokenizer}})}.}
  \begin{tabular}{l|ccc}
      \hline
