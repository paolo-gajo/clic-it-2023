...
Table~\ref{tab:english-italian-supervised-datasets-partition-stats} shows the class distribution of all five supervised corpora \abc{whereas Table~\ref{tab:incel-distribution} shows the distribution for our incel corpora.}
