...
\label{app:complete-results}
  ...
  \centering
  % \footnotesize
  \captionof{table}{Impact of incorporating additional datasets in English (Italian) when fine-tuning BERT (mBERT) and Incel BERT (Incel mBERT) on the mono- (top) and cross-lingual (bottom) hate speech detection task.}
